...
Extracted from hr.employees (salary, commission data)

Extracted from hr.salary_config (salary ranges and tax rates)

Transformed using payroll business logic (tax calculation, commission bonus calculation, gross and net pay computation)
